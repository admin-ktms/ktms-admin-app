...
function populateStatusFilters(data) {
  const registrationStatuses =
    Array.isArray(data?.registrationStatuses)
      ? data.registrationStatuses
      : [];

  const paymentStatuses =
    Array.isArray(data?.paymentStatuses)
      ? data.paymentStatuses
      : [];
...
function renderRegistrationSummary(data) {
  ...
  container.innerHTML = `
    <div class="ktms-registration-summary">
      ...
      <article
        class="ktms-registration-stat
               ktms-registration-stat-gold"
      >
        <span class="ktms-registration-stat-label">
    ...
    <section class="ktms-section">
      ...
      <div class="ktms-module-toolbar">
        <div>
          ...
          <p>
            Incoming registration records across
            the selected tournament scope.
          </p>
        </div>
      </div>
    ...
    <section class="ktms-section">
      ...
      <div class="ktms-module-toolbar">
        <div>
          ...
          <p>
            Confirmed registrations currently recorded
            by the tournament domain.
          </p>
        </div>
      </div>
